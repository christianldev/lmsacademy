...
const BlogDetailsRightSidebarComponent = () => {
  return (
    <>
          ...
          <ul className="d-flex align-items-center flex-wrap gap-2">
            <li>
              <div className="avatar avatar-sm rounded-pill me-2 flex-shrink-0">
                <span>
                  <Link href={all_routes.instructorDetails}>
                    <ImageWithBasePath
              ...
              <p>
                <Link href={all_routes.instructorDetails}>John Miller</Link>
              </p>
            </li>
            <li>
              <ImageWithBasePath
        ...
        <div className="p-3 text-center text-md-start p-lg-4 my-4 bg-light-900 rounded-2 d-md-flex align-items-center">
          ...
          <div className="ps-md-3 mt-2 mt-md-0">
            ...
            <h5 className="mb-1 fs-18">
              <Link href={all_routes.instructorDetails}>Robert Hollenbeck</Link>
            </h5>
            <p>
              ...
              <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div className="d-flex align-items-center mb-2">
                  <span className="avatar avatar-lg me-2 flex-shrink-0">
                    <Link href={all_routes.studentsDetails}>
                      <ImageWithBasePath
                  ...
                  <div>
                    <h5 className="fs-16 fw-medium">
                      <Link href={all_routes.studentsDetails}>Adrian Hendriques</Link>
                    </h5>
                  ...
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <div>
                      <h6 className="fs-16 fw-medium">
                        <Link href={all_routes.instructorDetails}>Rolands Granger</Link>
                      </h6>
                      <div className="d-flex align-items-center flex-wrap date-info">
                        <span className="mb-0 fs-14">2 days ago</span>
                      </div>
...
export default BlogDetailsRightSidebarComponent