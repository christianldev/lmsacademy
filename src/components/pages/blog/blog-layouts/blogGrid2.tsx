              ...
              <div className="blog">
                ...
                <div className="blog-item">
                  ...
                  <p className="text-truncate line-clamb-2">
                    Master the art of web application development with
                    expert-led courses that cover the latest tools, fram...
                  </p>
...
export default BlogGrid2Component;
