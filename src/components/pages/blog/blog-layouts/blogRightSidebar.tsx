...
const BlogRightSidebarComponent = () => {
  return (
    <>
                ...
                <div className="blog-info">
                  <div className="d-flex align-items-center flex-wrap justify-content-between">
                    <div className="d-flex align-items-center user-profile">
                      <Link href={all_routes.instructorDetails} className="user-img">
                        <ImageWithBasePath
                      ...
                      <Link href={all_routes.instructorDetails} className="user-name">
                        John Miller
                      </Link>
                    </div>
...
export default BlogRightSidebarComponent