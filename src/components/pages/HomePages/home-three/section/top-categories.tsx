            ...
            <div className="section how-it-works">
                <div className="container">
                    ...
                    >
                        ...
                        <div>
                            <Link href={route.courseCategory2} className="btn btn-secondary btn-xl">
                                View all Categories
                            </Link>
                        </div>
                    </div>
                    <Slider {...categoriesslider}>
                        ...
                        <div className="categories-item categories-item-two">
                            ...
                            <h5>
                                <Link href={route.courseCategory}>Docker Development</Link>
                            </h5>
                            <p>45 Instructors</p>
                        </div>
                        <div className="categories-item categories-item-two">
                            ...
                            <h5>
                                <Link href={route.courseCategory}>Node JS Frontend</Link>
                            </h5>
                            <p>40 Instructors</p>
                        </div>
                        <div className="categories-item categories-item-two">
                        ...
                        <div className="categories-item categories-item-two">
                            ...
                            <h5>
                                <Link href={route.courseCategory}>React Native</Link>
                            </h5>
                            <p>80 Instructors</p>
                        </div>
                    </Slider>
