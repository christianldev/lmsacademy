            ...
            <div className="section trend-course">
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <div>
                            <Link href={route.courseList} className="btn btn-secondary btn-xl">
                                View all Courses
                            </Link>
                        </div>
                    </div>
                                    ...
                                    <div className="course-content">
                                        <div className="course-user">
                                            <div className="course-user-img">
                                                <Link href={route.instructorProfile}>
                                                    <ImageWithBasePath
                                                ...
                                                <div className="course-name">
                                                    <h4>
                                                        <Link href={route.instructorProfile}>John Michael</Link>
                                                    </h4>
                                                    <p>Instructor</p>
                                                </div>
                                            </div>
                                            <div className="course-share d-flex align-items-center justify-content-center">
                                                <Link href="#" onClick={() => handleItemClick(12)}>
                                    ...
                                    <div className="course-content">
                                        <div className="course-user">
                                            <div className="course-user-img">
                                                ...
                                                <div className="course-name">
                                                    <h4>
                                                        <Link href={route.instructorProfile}>John Smith</Link>
                                                    </h4>
                                                    <p>Instructor</p>
                                                </div>
                                            </div>
                                            <div className="course-share d-flex align-items-center justify-content-center">
                                                <Link href="#" onClick={() => handleItemClick(11)}>
                                    ...
                                    <div className="course-content">
                                        <div className="course-user">
                                            <div className="course-user-img">
                                                ...
                                                <div className="course-name">
                                                    <h4>
                                                        <Link href={route.instructorProfile}>Lavern M.</Link>
                                                    </h4>
                                                    <p>Instructor</p>
                                                </div>
                                            </div>
                                            <div className="course-share d-flex align-items-center justify-content-center">
                                                <Link href="#" onClick={() => handleItemClick(10)}>
                                ...
                                >
                                    ...
                                    <div className="course-content">
                                        <div className="course-user">
                                            ...
                                            <div className="course-share d-flex align-items-center justify-content-center">
                                                <Link href="#" onClick={() => handleItemClick(9)}>
                                ...
                                >
                                    ...
                                    <div className="course-content">
                                        <div className="course-user">
                                            ...
                                            <div className="course-share d-flex align-items-center justify-content-center">
                                                <Link href="#" onClick={() => handleItemClick(8)}>
                                ...
                                >
                                    ...
                                    <div className="course-content">
                                        <div className="course-user">
                                            ...
                                            <div className="course-share d-flex align-items-center justify-content-center">
                                                <Link href="#" onClick={() => handleItemClick(7)}>
                                ...
                                >
                                    ...
                                    <div className="course-content">
                                        <div className="course-user">
                                            ...
                                            <div className="course-share d-flex align-items-center justify-content-center">
                                                <Link href="#" onClick={() => handleItemClick(6)}>
                        ...
                        <Slider {...trendingslider2} data-aos="fade-up">
                            <div className="instructor-item instructor-item-two">
                                <div className="instructors-img">
                                    <Link href={route.instructorList} tabIndex={0}>
                                        <ImageWithBasePath
                                            className="img-fluid"
                                            alt="Img"
                                    ...
                                    <div className="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        ...
                                        <Link href={route.courseList} className="course-count ms-auto">
                                            20 Courses
                                        </Link>
                                    </div>
                                ...
                                <div className="instructor-content">
                                    <h3 className="title">
                                        <Link href={route.instructorDetails}>David Lee</Link>
                                    </h3>
                            ...
                            <div className="instructor-item instructor-item-two">
                                <div className="instructors-img">
                                    ...
                                    <div className="position-absolute end-0 bottom-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        <Link href="#" key={2} className={`favourite ${selectedItems[2] ? 'selected' : ''} ms-auto`} onClick={() => handleItemClick(2)}>
                                            <i className="isax isax-heart" />
                                        </Link>
                                    </div>
                                </div>
                                <div className="instructor-content">
                                    <h3 className="title">
                                        <Link href={route.instructorDetails}>Daziy Millar</Link>
                                    </h3>
                            ...
                            <div className="instructor-item instructor-item-two">
                                <div className="instructors-img">
                                    ...
                                    <div className="position-absolute end-0 bottom-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        <Link href="#" key={3} className={`favourite ${selectedItems[3] ? 'selected' : ''} ms-auto`} onClick={() => handleItemClick(3)}>
                                            <i className="isax isax-heart" />
                                        </Link>
                                    </div>
                                </div>
                                <div className="instructor-content">
                                    <h3 className="title">
                                        <Link href={route.instructorDetails}>Patricia Mendoza</Link>
                                    </h3>
                                    <span className="designation">Web Developer</span>
                                    <div className="student-count">
                            ...
                            <div className="instructor-item instructor-item-two">
                                <div className="instructors-img">
                                    ...
                                    <div className="position-absolute end-0 bottom-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        <Link href="#" key={4} className={`favourite ${selectedItems[5] ? 'selected' : ''} ms-auto`} onClick={() => handleItemClick(5)}>
                                            <i className="isax isax-heart" />
                                        </Link>
                                    </div>
                                </div>
                                <div className="instructor-content">
                                    <h3 className="title">
                                        <Link href={route.instructorDetails}>Skyler Whites</Link>
                                    </h3>
                            ...
                            <div className="instructor-item instructor-item-two">
                                <div className="instructors-img">
                                    <Link href={route.instructorDetails} tabIndex={0}>
                                        <ImageWithBasePath
                                            className="img-fluid"
                                            alt="Img"
                                            src="assets/img/instructor/instructor-10.jpg"
                                    ...
                                    <div className="position-absolute end-0 bottom-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        <Link href="#" key={4} className={`favourite ${selectedItems[4] ? 'selected' : ''} ms-auto`} onClick={() => handleItemClick(4)}>
                                            <i className="isax isax-heart" />
                                        </Link>
                                    </div>
                                </div>
