              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div className="footer-widget footer-menu">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link href={all_routes.addNewCourse}>Enroll a Course</Link>
                    </li>
                    <li>
                      <Link href={all_routes.register}>Orders</Link>
                    </li>
                    <li>
                      <Link href={all_routes.pricingPlan}>Payments</Link>
                    </li>
                    <li>
                      <Link href={all_routes.contactUs}>Contact Us</Link>
                    </li>
                  </ul>
                </div>
                {/* /Footer Widget */}
              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div className="footer-widget footer-menu">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link href={all_routes.courseCategory}>Services</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href={all_routes.blogGrid3}>Blog</Link>
                    </li>
                  </ul>
                </div>
                {/* /Footer Widget */}
