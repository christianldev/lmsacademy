                ...
                <div className="container">
                        ...
                        <div className="row">
                                ...
                                <div className="instructor-item instructor-item-four">
                                    <div className="instructors-img ">
                                        ...
                                        <div className="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                                            ...
                                            <Link href="#" className="favourite ms-auto">
                                    ...
                                    <div className="instructor-content">
                                        <h5 className="title">
                                            <Link href={route.instructorDetails}>Julian Adrose</Link>
                                        </h5>
                            ...
                            >
                                <div className="instructor-item instructor-item-four">
                                    ...
                                    <div className="instructor-content">
                                        <h5 className="title">
                                            <Link href={route.instructorDetails}>Gallegos</Link>
                                        </h5>
                                        <span className="designation">Angular Expert</span>
                                        <div className="student-count">
                                            <i className="fa-solid fa-user-group me-2" />
                            ...
                            >
                                <div className="instructor-item instructor-item-four">
                                    ...
                                    <div className="instructor-content">
                                        <h5 className="title">
                                            <Link href={route.instructorDetails}>Kristi</Link>
                                        </h5>
                            ...
                            >
                                <div className="instructor-item instructor-item-four">
                                    ...
                                    <div className="instructor-content">
                                        <h5 className="title">
                                            <Link href={route.instructorDetails}>Pinero</Link>
                                        </h5>
                    ...
                    <div className="col-lg-12">
                        <div className="more-details text-center" data-aos="fade-up">
                            <Link href={route.instructorList} className="btn btn-secondary btn-xl">
