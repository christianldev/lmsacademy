            ...
            <section className="topcategory-sec">
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        >
                            <div className="categories-item categories-item-four flex-fill">
                                ...
                                <h5 className="title">
                                    <Link href={route.courseCategory}>Angular Development</Link>
                                </h5>
                                <p>220 Instructors</p>
                            </div>
                        </div>
                        ...
                        >
                            <div className="categories-item categories-item-four flex-fill">
                                ...
                                <h5 className="title">
                                    <Link href={route.courseCategory}>Nodeman Development</Link>
                                </h5>
                                <p>124 Instructors</p>
                            </div>
                        </div>
                        ...
                        >
                            <div className="categories-item categories-item-four flex-fill">
                                ...
                                <h5 className="title">
                                    <Link href={route.courseCategory}>Node Js Development</Link>
                                </h5>
                                <p>120 Instructors</p>
                            </div>
                        </div>
                        ...
                        >
                            <div className="categories-item categories-item-four flex-fill">
                                ...
                                <h5 className="title">
                                    <Link href={route.courseCategory}>AWS Development</Link>
                                </h5>
                                <p>285 Instructors</p>
                            </div>
                        </div>
                        ...
                        >
                            <div className="categories-item categories-item-four flex-fill">
                                ...
                                <h5 className="title">
                                    <Link href={route.courseCategory}>Strapi CMS</Link>
                                </h5>
                                <p>99 Instructors</p>
                            </div>
                        </div>
                        ...
                        >
                            <div className="categories-item categories-item-four flex-fill">
                                ...
                                <h5 className="title">
                                    <Link href={route.courseCategory}>Swift Development</Link>
                                </h5>
                                <p>64 Instructors</p>
                            </div>
                        </div>
                        ...
                        >
                            <div className="categories-item categories-item-four flex-fill">
                                ...
                                <h5 className="title">
                                    <Link href={route.courseCategory}>VUE JS Development</Link>
                                </h5>
                                <p>32 Instructors</p>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex">
                            ...
                            >
                                ...
                                <h5 className="title">
                                    <Link href={route.courseCategory}>ApostropheCMS</Link>
                                </h5>
                                <p>21 Instructors</p>
                            </div>
                        </div>
                    ...
                    <div className="more-details text-center" data-aos="fade-down">
                        <Link href={route.courseCategory3} className="btn btn-secondary btn-xl">
                            View all Category
                        </Link>
                    </div>
                    {/* /View all Category */}
