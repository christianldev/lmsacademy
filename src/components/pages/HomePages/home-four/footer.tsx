          ...
          <div className="row row-gap-4">
            <div className="col-lg-3">
              <div className="footer-widget footer-menu">
                ...
                <ul>
                  <li>
                    <Link href={all_routes.courseGrid}>Search Mentors</Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href={all_routes.courseList}>Booking</Link>
                  </li>
                  <li>
                    <Link href={all_routes.studentDashboard}>Students Dashboard</Link>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="footer-widget footer-menu">
                ...
                <ul>
                  ...
                  <li>
                    <Link href={all_routes.instructorMessage}>Chat</Link>
                  </li>
                  <li>
                    <Link href={all_routes.login}>Login</Link>
                  </li>
                  ...
                  <li>
                    <Link href={all_routes.instructorDashboard}>Instructor Dashboard</Link>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="col-md-6">
          <div className="text-center text-md-start">
            <p className="text-white">
              Copyright © 2026 DreamsLMS. All rights reserved.
            </p>
          </div>
        </div>
        <div className="col-md-6">
