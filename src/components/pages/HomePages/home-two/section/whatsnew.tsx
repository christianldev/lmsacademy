                            ...
                            <div className="course-item-two course-item">
                                <div className="course-img">
                                    ...
                                    <div className="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                                        <Link href="#" key={1} className={`fav-icon ${selectedItems[1] ? 'selected' : ''}`} onClick={() => handleItemClick(1)}>
                                            <i className="isax isax-heart" />
                                        </Link>
                                        <Link href="#" className="brand-icon ms-auto">
                                            <ImageWithBasePath
                        ...
                        <div className="item">
                            <div className="course-item-two course-item">
                                <div className="course-img">
                                    ...
                                    <div className="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                                        <Link href="#" key={2} className={`fav-icon ${selectedItems[2] ? 'selected' : ''}`} onClick={() => handleItemClick(2)}>
                                            <i className="isax isax-heart" />
                                        </Link>
                                        <Link href="#" className="brand-icon ms-auto">
                                            <ImageWithBasePath
                        ...
                        <div className="item">
                            <div className="course-item-two course-item">
                                <div className="course-img">
                                    ...
                                    <div className="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                                        <Link href="#" key={3} className={`fav-icon ${selectedItems[3] ? 'selected' : ''}`} onClick={() => handleItemClick(3)}>
                                            <i className="isax isax-heart" />
                                        </Link>
                                        <Link href="#" className="brand-icon ms-auto">
                                            <ImageWithBasePath
                        ...
                        <div className="item">
                            <div className="course-item-two course-item">
                                <div className="course-img">
                                    ...
                                    <div className="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                                        <Link href="#" key={4} className={`fav-icon ${selectedItems[4] ? 'selected' : ''}`} onClick={() => handleItemClick(4)}>
                                            <i className="isax isax-heart" />
                                        </Link>
                                        <Link href="#" className="brand-icon ms-auto">
                                            <ImageWithBasePath
                        ...
                        <div className="item">
                            <div className="course-item-two course-item">
                                <div className="course-img">
                                    ...
                                    <div className="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                                        <Link href="#" key={5} className={`fav-icon ${selectedItems[5] ? 'selected' : ''}`} onClick={() => handleItemClick(5)}>
                                            <i className="isax isax-heart" />
                                        </Link>
                                        <Link href="#" className="brand-icon ms-auto">
                                            <ImageWithBasePath
