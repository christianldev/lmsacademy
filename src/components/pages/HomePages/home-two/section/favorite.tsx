                        ...
                        <Slider {...favoriteslider}>
                            <div className="item aos" data-aos="flip-right">
                                <div className="categories-item">
                                    ...
                                    <h5 className="fw-semi-bold mb-1">
                                        <Link href={route.courseCategory}>Management</Link>
                                    </h5>
                            ...
                            <div className="item aos" data-aos="flip-right">
                                <div className="categories-item">
                                    ...
                                    <h5 className="fw-semi-bold mb-1">
                                        <Link href={route.courseCategory} className='text-truncate'>IT &amp; Softwares</Link>
                                    </h5>
                            ...
                            <div className="item aos" data-aos="flip-right">
                                <div className="categories-item">
                                    ...
                                    <h5 className="fw-semi-bold mb-1">
                                        <Link href={route.courseCategory}>Marketing</Link>
                                    </h5>
                            ...
                            <div className="item aos" data-aos="flip-right">
                                <div className="categories-item">
                                    <div className="card-body text-center">
                                        ...
                                        <h5 className="fw-semi-bold mb-1">
                                            <Link href={route.courseCategory}>Productivity</Link>
                                        </h5>
                            ...
                            <div className="item aos" data-aos="flip-right">
                                <div className="categories-item">
                                    <div className="card-body text-center">
                                        ...
                                        <h5 className="fw-semi-bold mb-1">
                                            <Link href={route.courseCategory}>Lifestyles</Link>
                                        </h5>
                                        <p className="mb-0">214 Courses</p>
                                    </div>
                                </div>
                            ...
                            <div className="item aos" data-aos="flip-right">
                                <div className="categories-item">
                                    <div className="card-body text-center">
                                        ...
                                        <h5 className="fw-semi-bold mb-1">
                                            <Link href={route.courseCategory}>Design</Link>
                                        </h5>
