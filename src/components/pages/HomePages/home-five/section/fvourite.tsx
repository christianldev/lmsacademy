                                ...
                                <Slider {...favouriteslider}>
                                    ...
                                    >
                                        ...
                                        <div className="category-info">
                                            <h3>
                                                <Link href={route.courseDetails}>Angular Development</Link>
                                            </h3>
                                        </div>
                                    ...
                                    >
                                        ...
                                        <div className="category-info">
                                            <h3>
                                                <Link href={route.courseDetails}>Pyhton Developmentt</Link>
                                            </h3>
                                        </div>
                                        <div className="instructors-info">
                                            <p className="me-4">Instructors</p>
                                    ...
                                    >
                                        <div className="favourite-item flex-fill">
                                            ...
                                            <div className="category-info">
                                                <h3>
                                                    <Link href={route.courseDetails}>NODE JS Development</Link>
                                                </h3>
                                            </div>
                                            <div className="instructors-info">
                                                <p className="me-4">Instructors</p>
                                    ...
                                    >
                                        <div className="favourite-item flex-fill">
                                            ...
                                            <div className="category-info">
                                                <h3>
                                                    <Link href={route.courseDetails}>Corephp Development</Link>
                                                </h3>
                                            </div>
                                            <div className="instructors-info">
                                                <p className="me-4">Instructors</p>
                                    ...
                                    >
                                        <div className="favourite-item flex-fill">
                                            ...
                                            <div className="category-info">
                                                <h3>
                                                    <Link href={route.courseDetails}>Laravel Development</Link>
                                                </h3>
                                            </div>
                                            <div className="instructors-info">
                                                <p className="me-4">Instructors</p>
