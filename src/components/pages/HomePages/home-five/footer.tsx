            ...
            <div className="row gy-4">
              <div className="col-md-6 d-lg-flex justify-content-end">
                ...
                <div className="footer-widget-three footer-menu-three footer-three-right">
                  ...
                  <ul>
                    <li>
                      <Link href={all_routes.instructorProfile}>Profile</Link>
                    </li>
                    <li>
                      <Link href={all_routes.login}>Login</Link>
                    </li>
                    <li>
                      <Link href={all_routes.register}>Register</Link>
                    </li>
                    <li>
                      <Link href={all_routes.instructorList}>Instructor</Link>
                    </li>
                    <li>
                      <Link href={all_routes.instructorDashboard}> Dashboard</Link>
                    </li>
                  </ul>
                </div>
                {/* /Footer Widget */}
              ...
              <div className="col-md-6 d-lg-flex justify-content-end">
                ...
                <div className="footer-widget-three footer-menu-three">
                  ...
                  <ul>
                    <li>
                      <Link href={all_routes.studentProfile}>Profile</Link>
                    </li>
                    <li>
                      <Link href={all_routes.login}>Login</Link>
                    </li>
                    ...
                    <li>
                      <Link href={all_routes.studentsList}>Student</Link>
                    </li>
                    <li>
                      <Link href={all_routes.studentDashboard}> Dashboard</Link>
                    </li>
                  </ul>
                </div>
                {/* /Footer Widget */}
      ...
      <div className="row row-gap-3">
        <div className="col-lg-4">
          <div className="copyright-text">
            <p>
              Copyright 2026 © <Link href="#">DreamsLMS</Link>. All
              right reserved.
            </p>
          </div>
        </div>
        <div className="col-lg-4">
          <div className="privacy-link">
            <Link href={all_routes.termsConditions} className="mb-0">
              Terms &amp; Policy
            </Link>
