                    ...
                    <Slider {...featurinstructorslider} className="featured-instructor-slider lazy">
                        ...
                        >
                            ...
                            <div className="instructor-content">
                                <div>
                                    <h3 className="title">
                                        <Link href={route.instructorDetails}>Joyce Pence</Link>
                                    </h3>
                        ...
                        >
                            ...
                            <div className="instructor-content">
                                <div>
                                    <h3 className="title">
                                        <Link href={route.instructorDetails}>Edith Dorsey</Link>
                                    </h3>
                        ...
                        >
                            ...
                            <div className="instructor-content">
                                <div>
                                    <h3 className="title">
                                        <Link href={route.instructorDetails}>Ruben Holmes</Link>
                                    </h3>
                        ...
                        >
                            ...
                            <div className="instructor-content">
                                <div>
                                    <h3 className="title">
                                        <Link href={route.instructorDetails}>Carol Magner</Link>
                                    </h3>
                                    <span className="designation">Lead Designer</span>
                                </div>
                                <p className="rating">
