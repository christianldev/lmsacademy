                        ...
                        <Slider {...featurecourseslider}>
                                ...
                                <div>
                                    <div className="course-item">
                                        ...
                                        <Link href={route.courseDetails} className="btn buy-course-btn">
                                            Buy Course Now
                                        </Link>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div className="course-item">
                                        <div className="course-img">
                                            <Link href={route.courseDetails2}>
                                                <ImageWithBasePath
                                                    src="assets/img/course/course-37.jpg"
                                                    alt="img"
                                                    className="img-fluid"
