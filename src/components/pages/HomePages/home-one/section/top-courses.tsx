        ...
        <>
            ...
            <section className="top-courses-sec">
                ...
                <div className="container">
                    <div className="section-header text-center">
                        ...
                        <div>
                            <div className="categories-item categories-item-three mb-0">
                                ...
                                />
                                <h6 className="title">
                                    <Link href={route.courseCategory}>Frontend Developer</Link>
                                </h6>
                            </div>
                        </div>
                        <div>
                            <div className="categories-item categories-item-three mb-0">
                                ...
                                />
                                <h6 className="title">
                                    <Link href={route.courseCategory}>Jira Management</Link>
                                </h6>
                            </div>
                        </div>
                        <div>
                            <div className="categories-item categories-item-three mb-0">
                                ...
                                />
                                <h6 className="title">
                                    <Link href={route.courseCategory}>Figma Developer</Link>
                                </h6>
                            </div>
                        </div>
                        <div>
                            <div className="categories-item categories-item-three mb-0">
                                ...
                                />
                                <h6 className="title">
                                    <Link href={route.courseCategory}>Framer Developer</Link>
                                </h6>
                            </div>
                        </div>
                        <div>
                            <div className="categories-item categories-item-three mb-0">
                                ...
                                />
                                <h6 className="title">
                                    <Link href={route.courseCategory}>Vue js Developer</Link>
                                </h6>
                            </div>
                        </div>
                        <div>
                            <div className="categories-item categories-item-three mb-0">
                                ...
                                />
                                <h6 className="title">
                                    <Link href={route.courseCategory}>Shopify Developer</Link>
                                </h6>
                            </div>
                        </div>
                        <div>
                    ...
                    <Link href={route.courseCategory} className="btn btn-primary btn-md">
                        View All Categories
                    </Link>
                </div>
            </section>
