                    ...
                    <Slider {...testimonialslider} className="testimonials-slider lazy mt-4">
                        <div>
                            ...
                            >
                                ...
                                <h6 className="mb-1">
                                    <Link href={route.studentsDetails}>Brenda Slaton</Link>
                                </h6>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <h6 className="mb-1">
                                    <Link href={route.studentsDetails}>Adrian Dennis</Link>
                                </h6>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <h6 className="mb-1">
                                    <Link href={route.studentsDetails}>Adrian Coztanza</Link>
                                </h6>
