                                                    ...
                                                    <div className="course-user">
                                                        <div className="course-user-img">
                                                            ...
                                                            <div className="course-name">
                                                                <h4>
                                                                    <Link href={route.instructorProfile}>Nicole Brown</Link>
                                                                </h4>
                                                                <p>Instructor</p>
                                                            </div>
                                                        </div>
                                                        <Link href="#" key={1} className={`fav-icon ${selectedItems[1] ? 'selected' : ''} ms-auto`} onClick={() => handleItemClick(1)}>
                                                ...
                                                <div className="course-content">
                                                    <div className="course-user">
                                                        <div className="course-user-img">
                                                            ...
                                                            <div className="course-name">
                                                                <h4>
                                                                    <Link href={route.instructorProfile}>Jenis R.</Link>
                                                                </h4>
                                                                <p>Instructor</p>
                                                            </div>
                                                        </div>
                                                        <Link href="#" key={2} className={`fav-icon ${selectedItems[2] ? 'selected' : ''} ms-auto`} onClick={() => handleItemClick(2)}>
                                                            <i className="fa-regular fa-heart" />
                                                        </Link>
                                                    </div>
                                                    <h3 className="title">
                                            ...
                                            >
                                                ...
                                                <div className="course-content">
                                                    <div className="course-user">
                                                        ...
                                                        <Link href="#" key={3} className={`fav-icon ${selectedItems[3] ? 'selected' : ''} ms-auto`} onClick={() => handleItemClick(3)}>
                                                            <i className="fa-regular fa-heart" />
                                                        </Link>
                                                    </div>
                                                    <h3 className="title">
                                                ...
                                                <div className="course-content">
                                                    <div className="course-user">
                                                        ...
                                                        <div className="course-share d-flex align-items-center justify-content-center">
                                                            <Link href="#" key={4} className={`fav-icon ${selectedItems[4] ? 'selected' : ''} ms-auto`} onClick={() => handleItemClick(4)}>
                                                                <i className="fa-regular fa-heart" />
                                                            </Link>
                                                        </div>
                                                    </div>
                                            ...
                                            >
                                                ...
                                                <div className="course-content">
                                                    <div className="course-user">
                                                        ...
                                                        <Link href="#" key={5} className={`fav-icon ${selectedItems[5] ? 'selected' : ''} ms-auto`} onClick={() => handleItemClick(5)}>
                                                            <i className="fa-regular fa-heart" />
                                                        </Link>
                                                    </div>
                                                    <h3 className="title">
                                            ...
                                            >
                                                ...
                                                <div className="course-content">
                                                    <div className="course-user">
                                                        ...
                                                        <Link href="#" key={6} className={`fav-icon ${selectedItems[6] ? 'selected' : ''} ms-auto`} onClick={() => handleItemClick(6)}>
                                                            <i className="fa-regular fa-heart" />
                                                        </Link>
                                                    </div>
                                                    <h3 className="title">
