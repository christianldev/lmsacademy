                ...
                <div className="container">
                    ...
                    <Slider {...categoriesslider}>
                        ...
                        >
                            <div className="categories-icon">
                                <div className="icon-bg">
                                    <Link href={route.courseCategory}>
                                        <ImageWithBasePath src="assets/img/icon/framework-01.svg" alt="Img" />
                                    </Link>
                                </div>
                            </div>
                            <h3 className="title">
                                <Link href={route.courseCategory}>Angular</Link>
                            </h3>
                            <p>50 Instructors</p>
                            <Link href={route.courseCategory} className="view-icon">
                        ...
                        >
                            ...
                            <h3 className="title">
                                <Link href={route.courseCategory}>React JS</Link>
                            </h3>
                            <p>50 Instructors</p>
                            <Link href={route.courseCategory} className="view-icon">
                                <i className="fas fa-chevron-right" />
                        ...
                        >
                            ...
                            <h3 className="title">
                                <Link href={route.courseCategory}>Node JS</Link>
                            </h3>
                            <p>30 Instructors</p>
                            <Link href={route.courseCategory} className="view-icon">
                                <i className="fas fa-chevron-right" />
                        ...
                        >
                            ...
                            <h3 className="title">
                                <Link href={route.courseCategory}>Docker</Link>
                            </h3>
                            <p>60 Instructors</p>
                            <Link href={route.courseCategory} className="view-icon">
                                <i className="fas fa-chevron-right" />
