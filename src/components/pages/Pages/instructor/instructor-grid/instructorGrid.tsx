                    ...
                    <div className="instructor-item instructor-item-six flex-fill">
                      ...
                      <div className="instructor-content">
                        <div>
                          ...
                          <h3 className="title mb-2">
                            <Link href={route.instructorDetails}>Lisa Lopez</Link>
                          </h3>
                    ...
                    <div className="instructor-item instructor-item-six flex-fill">
                      ...
                      <div className="instructor-content">
                        <div>
                          ...
                          <h3 className="title mb-2">
                            <Link href={route.instructorDetails}>Ivana Tow</Link>
                          </h3>
...
export default InstructorGridComponent;
