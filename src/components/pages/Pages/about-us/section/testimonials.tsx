"use client";import ImageWithBasePath from "@/core/common/imageWithBasePath";
          ...
          <Slider {...testimonialsSlider} className="testimonials-slider lazy mt-4">
            <div>
              <div className="testimonials-item rounded-3 bg-white">
                ...
                <h6 className="mb-1">
                  <Link href={route.instructorDetails}>Brenda Slaton</Link>
                </h6>
            ...
            <div>
              <div className="testimonials-item rounded-3 bg-white">
                ...
                <h6 className="mb-1">
                  <Link href={route.instructorDetails}>Adrian Dennis</Link>
                </h6>
            ...
            <div>
              <div className="testimonials-item rounded-3 bg-white">
                ...
                <h6 className="mb-1">
                  <Link href={route.instructorDetails}>Adrian Coztanza</Link>
                </h6>
