...
const InstructorMessageComponent = () => {
            ...
            <div className="msg_head">
              ...
              <div className="d-flex align-items-center send-action">
                ...
                <ul className="dropdown-menu dropdown-menu-end p-3">
                  <li>
                    <Link href={all_routes.homeone} className="dropdown-item">
            ...
            <div className="d-flex align-items-center">
              <div className="d-flex align-items-center chat-input-icons">
                ...
                <div className="form-item emoj-action-foot">
                  <Link href="javascrip:void(0);" className="action-circle">
...
export default InstructorMessageComponent
