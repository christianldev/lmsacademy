...
const InstructorStatementComponent = () => {
  ...
  const columns = [
    {
      ...
      dataIndex: "OrderID",
      render: (text: string) => (
        <Link href="#" data-bs-toggle="modal" data-bs-target="#view_invoice">
          {text}
        </Link>
      ),
    ...
    },
    {
      ...
      render: () => (
        <div className="d-flex align-items-center">
          ...
          <Link href="#" className="d-inline-flex fs-14 action-icon">
                ...
                <div className="row g-4">
                  ...
                  <div className="col-lg-5">
                    ...
                    <div>
                      ...
                      <p className="fs-14 mb-1">
                        Email : <Link href="#">adre3@example.com</Link>
                      </p>
                      <p className="fs-14">
                        Phone : <Link href="#">+1 987 471 6589</Link>
                      </p>
                    </div>
                  </div>
...
export default InstructorStatementComponent;
