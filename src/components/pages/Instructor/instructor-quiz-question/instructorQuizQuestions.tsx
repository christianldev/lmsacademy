...
const InstructorQuizQuestionsComponent = () => {
  const options = [
          ...
          <div className="row">
            ...
            <div className="col-lg-9">
                  ...
                  <div className="row align-items-center gy-3">
                    <div className="col-xl-8">
                      <div>
                        <div className="d-sm-flex align-items-center">
                          ...
                          <div>
                            <h5 className="mb-2"><Link href="#">Information About UI/UX Design Degree</Link></h5>
                    ...
                    <div className="col-xl-4">
                      <div className="d-flex align-items-center justify-content-sm-end">
                        <Link href={all_routes.instructorQuizResult} className="text-info text-decoration-underline fs-12 fw-medium me-3">View Results</Link>
                        <Link href="#" className="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#add_question">Add Question</Link>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <div className="d-flex align-items-center justify-content-end">
                      <Link href="#" className="d-inline-flex fs-14 me-2 action-icon" data-bs-toggle="modal" data-bs-target="#edit_question"><i className="isax isax-edit-2"></i></Link>
                      <Link href="#" className="d-inline-flex fs-14 action-icon" data-bs-toggle="modal" data-bs-target="#delete_modal"><i className="isax isax-trash"></i></Link>
                    </div>
                  </div>
                  <div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <div className="d-flex align-items-center justify-content-end">
                      <Link href="#" className="d-inline-flex fs-14 me-2 action-icon" data-bs-toggle="modal" data-bs-target="#edit_question"><i className="isax isax-edit-2"></i></Link>
                      <Link href="#" className="d-inline-flex fs-14"><i className="isax isax-trash" data-bs-toggle="modal" data-bs-target="#delete_modal"></i></Link>
                    </div>
                  </div>
                  <div>
                    <div className="form-check mb-2">
              ...
              <div className="text-center">
                <Link href="#" className="btn btn-secondary">Load More</Link>
              </div>
            </div>
          </div>
        </div>
...
export default InstructorQuizQuestionsComponent