                ...
                <div className="instructor-details">
                  ...
                  <div className="flex-fill">
                    <div className="pb-3 border-bottom mb-3">
                      ...
                      <div>
                        <p>
                          Hello! I'm Thompson Hicks. I'm passionate about
                    ...
                    <div>
                      <div className="course-item-two course-item mx-2">
                        <div className="course-img">
                          <Link href={all_routes.courseDetails}>
                            <ImageWithBasePath
                          ...
                          <div className="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                            ...
                            <Link href="#" className="fav-icon ms-auto">
                        ...
                        <div className="course-content">
                          <div className="d-flex justify-content-between mb-2">
                            <div className="d-flex align-items-center">
                              <Link
                                href={all_routes.instructorDetails}
...
export default StudentsDetailsComponent;
