...
const StudentWishlistComponent = () => {
                  ...
                  <div className="course-item course-item-three">
                    <div className="position-relative overflow-hidden rounded-3 mb-3">
                      ...
                      <div className="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                        <Link className="fav-icon like selected" href="#">
                    ...
                    <div className="d-flex flex-wrap align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        <div className="avatar avatar-sm rounded-circle">
                          <Link href={route.instructorDetails}>
                            <ImageWithBasePath
                  ...
                  <div className="course-item course-item-three">
                    ...
                    <div className="d-flex flex-wrap align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        ...
                        <p className="fs-14 ms-2">
                          <Link href={route.instructorDetails}>Nancy Duarte</Link>
                        </p>
                      </div>
                  ...
                  <div className="course-item course-item-three">
                    ...
                    <div className="d-flex flex-wrap align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        ...
                        <p className="fs-14 ms-2">
                          <Link href={route.instructorDetails}>James Kagan</Link>
                        </p>
                      </div>
                      <span className="tag-btn">Programming</span>
                    </div>
            ...
            <div className="modal-body text-center custom-modal-body">
              ...
              <div>
                ...
                <div className="d-flex align-items-center justify-content-center">
                  ...
                  <Link href="#" className="btn btn-secondary rounded-pill"  data-bs-dismiss="modal">
                    Yes, Remove All
                  </Link>
                </div>
              </div>
