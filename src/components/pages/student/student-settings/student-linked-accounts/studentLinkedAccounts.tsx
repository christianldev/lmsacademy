...
const StudentLinkedAccountsComponent = () => {
                    ...
                    <div className="col-md-12">
                      <div className="d-flex align-items-center border-bottom mb-4 pb-4">
                        ...
                        <div className="d-sm-flex align-items-center justify-content-between w-100">
                          ...
                          <Link href="#" className="btn btn-dark flex-shrink-0">
                            Remove
                          </Link>
                        </div>
                      </div>
                      <div className="d-flex align-items-center border-bottom mb-4 pb-4">
                        ...
                        <div className="d-sm-flex align-items-center justify-content-between w-100">
                          ...
                          <Link href="#" className="btn btn-light flex-shrink-0">
                            Link Account
                          </Link>
                        </div>
                      </div>
...
export default StudentLinkedAccountsComponent;
