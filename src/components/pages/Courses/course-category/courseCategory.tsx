                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Logo Design</Link>
                          </h6>
                        </div>
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Brand Style Guides</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Game Art</Link>
                          </h6>
                        </div>
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Business Cards</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          22
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Illustration</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Pattern Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Brochure Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          14
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Flyer Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Book Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Social Media Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          12
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Icon Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Invitation Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Graphics for Streamers</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          06
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Label Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>UX Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Photoshop Editing</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          10
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Presentation Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
                    ...
                    <div className="course-category-item">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <h6 className="pe-2">
                            <Link href={route.courseDetails}>Infographic Design</Link>
                          </h6>
                        </div>
                        <span className="cat-count text-white fw-medium bg-dark d-inline-flex">
                          15
